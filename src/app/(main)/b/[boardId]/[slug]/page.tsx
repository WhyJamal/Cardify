            ...
            <div className="flex items-start gap-3 h-full min-w-max mt-11">
              ...
              {addingColumn ? (
                ...
                <button
                  ...
                  className={`shrink-0 w-64 flex items-center gap-2 px-3 py-2.5 bg-white/20 backdrop-blur-sm rounded-xl text-sm font-medium transition-all border border-black/15 ${board?.isPhoto ? "text-fuchsia-950 hover:bg-white/5" : "text-white hover:bg-white/30"
                    }`}
                >
                  <Plus size={16} />
                  Добавить список

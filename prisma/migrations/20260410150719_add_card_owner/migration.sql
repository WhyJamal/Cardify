...
INSERT INTO "new_Card" ("assigneeColor", "assigneeInitials", "background", "checklistDone", "checklistTotal", "columnId", "createdAt", "description", "dueDate", "hasDescription", "id", "image", "isArchive", "isCompleted", "isImage", "numberBadge", "position", "size", "textColor", "title", "updatedAt", "watching") SELECT "assigneeColor", "assigneeInitials", "background", "checklistDone", "checklistTotal", "columnId", "createdAt", "description", "dueDate", "hasDescription", "id", "image", "isArchive", "isCompleted", "isImage", "numberBadge", "position", "size", "textColor", "title", "updatedAt", "watching" FROM "Card";
DROP TABLE "Card";

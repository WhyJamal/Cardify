...
export default function MapPage() {
    ...
    return (
        <div className="fixed inset-0 flex flex-col">
            <div className="absolute top-3 left-3 z-1000 flex rounded-lg overflow-hidden border border-white/20 shadow-lg">
                {([
            ...
            <button className="absolute top-3 right-3 z-1000 flex items-center gap-2 bg-[#282e33] hover:bg-[#38414a] text-[#9fadbc] hover:text-white border border-white/20 text-sm px-3 py-1.5 rounded-lg shadow-lg transition-colors">
                <Plus size={14} />
                Добавить карточку
            </button>

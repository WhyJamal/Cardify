/*
  ...
  - You are about to drop the column `activityText` on the `Card` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "CardMember" ADD COLUMN "activityText" TEXT;
...
INSERT INTO "new_Card" ("assigneeColor", "assigneeInitials", "background", "checklistDone", "checklistTotal", "columnId", "createdAt", "description", "dueDate", "hasDescription", "id", "image", "isArchive", "isCompleted", "isImage", "numberBadge", "ownerId", "position", "size", "textColor", "title", "updatedAt", "watching") SELECT "assigneeColor", "assigneeInitials", "background", "checklistDone", "checklistTotal", "columnId", "createdAt", "description", "dueDate", "hasDescription", "id", "image", "isArchive", "isCompleted", "isImage", "numberBadge", "ownerId", "position", "size", "textColor", "title", "updatedAt", "watching" FROM "Card";
DROP TABLE "Card";
